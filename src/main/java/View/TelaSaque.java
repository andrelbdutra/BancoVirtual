...
public class TelaSaque extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(txtSaque, javax.swing.GroupLayout.DEFAULT_SIZE, 368, Short.MAX_VALUE))
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        System.out.println(new ListaConta().getContas().get(id).getID());
        System.out.println(new ListaConta().getContas().get(id).getSaldo());
        new TelaPrincipal(id).setVisible(true);
        this.dispose();
